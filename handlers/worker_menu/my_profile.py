...
from keyboards.inline_plain import MyProfileKeyboard
...
async def process_nickname(msg: types.Message):
    ...
    return UpdateData(on_conv_exit=QuestText('Никнейм обновлен', WorkerKeyboard()))
...
async def miss_phone_number(msg: types.Message):
    ...
    return UpdateData(on_conv_exit=QuestText('Номер телефона сброшен', WorkerKeyboard()))
...
async def process_phone_number(msg: types.Message):
    ...
    return UpdateData(on_conv_exit=QuestText('Номер телефона обновлен', WorkerKeyboard()))
...
async def process_email(msg: types.Message):
    ...
    return UpdateData(on_conv_exit=QuestText('Email изменен', WorkerKeyboard()))
...
async def process_biography(msg: types.Message):
    ...
    return UpdateData(on_conv_exit=QuestText('Биография обновлена', WorkerKeyboard()))
...
async def process_works_finish(msg: types.Message, state: FSMContext):
    ...
    return UpdateData(on_conv_exit=QuestText('Примеры работ обновлены', WorkerKeyboard()))
